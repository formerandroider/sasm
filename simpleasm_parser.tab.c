...
#line 80 "simpleasm_parser.tab.c"
...
#ifndef YY_YY_SIMPLEASM_PARSER_TAB_H_INCLUDED
# define YY_YY_SIMPLEASM_PARSER_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_SIMPLEASM_PARSER_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "\"T_OPERATION\"", "\"T_ADDRESS\"",
  "\"T_NUM\"", "\"T_IDENTIFIER\"", "\"T_LABEL\"", "$accept", "input",
  "operation_line", "operation_call", "operation_arg", "address", YY_NULLPTR
};
#endif
...
#line 37 "simpleasm_parser.y"
    {
        ...
        sprintf(op->operation, "%s", (yyvsp[-1].OPERATION));
        free((yyvsp[-1].OPERATION));
        op->address = (yyvsp[0].operation_arg);
